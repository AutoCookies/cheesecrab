...
import (
	...
	"github.com/AutoCookies/cheesecrab/pkg/cheesecrab/internal/orderedmap"
	"github.com/AutoCookies/cheesecrab/pkg/cheesecrab/types/model"
)
...
type GenerateRequest struct {
	...
	// the model name (e.g. from a library or path)
...
type CreateRequest struct {
	...
	// RemoteHost is the URL of the upstream API for the model (if any).
	RemoteHost string `json:"remote_host,omitempty"`
