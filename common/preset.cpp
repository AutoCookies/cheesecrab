...
common_preset_context::common_preset_context(cheese_example ex, bool only_remote_allowed)
...
common_presets common_preset_context::load_from_models_dir(const std::string & models_dir) const {
    ...
    for (const auto & model : models) {
        ...
        preset.set_option(*this, "CHEESE_ARG_MODEL", model.path);
        if (!model.path_mmproj.empty()) {
            preset.set_option(*this, "CHEESE_ARG_MMPROJ", model.path_mmproj);
        }
        out[preset.name] = preset;
    }
