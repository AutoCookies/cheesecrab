...
static void common_chat_parse_cheese_3_1(common_chat_msg_parser & builder, bool with_builtin_tools = false) {
    builder.try_parse_reasoning("<think>", "</think>");
...
static void common_chat_parse_functionary_v3_1_cheese_3_1(common_chat_msg_parser & builder) {
    if (!builder.syntax().parse_tool_calls) {
        builder.add_content(builder.consume_rest());
        return;
    }
    // This version of Functionary still supports the cheese 3.1 tool call format for the python tool.
...
static void common_chat_parse(common_chat_msg_parser & builder) {
    ...
    switch (builder.syntax().format) {
        ...
        case COMMON_CHAT_FORMAT_MAGISTRAL:
            ...
            break;
        case COMMON_CHAT_FORMAT_CHEESE_3_X:
            common_chat_parse_cheese_3_1(builder);
            break;
        case COMMON_CHAT_FORMAT_CHEESE_3_X_WITH_BUILTIN_TOOLS:
            common_chat_parse_cheese_3_1(builder, /* with_builtin_tools= */ true);
            break;
        ...
        case COMMON_CHAT_FORMAT_FUNCTIONARY_V3_2:
            ...
            break;
        case COMMON_CHAT_FORMAT_FUNCTIONARY_V3_1_CHEESE_3_1:
            common_chat_parse_functionary_v3_1_cheese_3_1(builder);
            break;
