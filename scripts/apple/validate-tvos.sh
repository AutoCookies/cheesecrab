#!/usr/bin/env bash
# validate-tvos.sh - Validate tvOS Application with embedded cheese.xcframework using SwiftUI
...
# Configuration
APP_NAME="TVOSCheeseTest"
BUNDLE_ID="org.ggml.TVOSCheeseTest"
...
struct ContentView: View {
    ...
    var body: some View {
        VStack(spacing: 40) {
            Text("Cheese Framework Test on tvOS")
                .font(.largeTitle)
                .padding()
...
cat >> "${TEMP_DIR}/${APP_NAME}/${APP_NAME}.xcodeproj/project.pbxproj" << 'EOF'
        ...
        EEEEEEEEEEEEEEEEEEEEEEEE = {
            isa = PBXGroup;
            children = (
                FFFFFFFFFFFFFFFFFFFFFFFF /* TVOSCheeseTest */,
                CCCCCCCCCCCCCCCCCCCCCCCC /* Products */,
                DDDDDDDDDDDDDDDDDDDDDDDD /* Frameworks */,
            );
            sourceTree = "<group>";
...
/* Begin XCBuildConfiguration section */
        ...
        BBBBBBBBBBBBBBBBBBBBBBCCC /* Debug */ = {
            ...
            buildSettings = {
                ...
                INFOPLIST_FILE = "TVOSCheeseTest/Info.plist";
                LD_RUNPATH_SEARCH_PATHS = (
                    "$(inherited)",
                    "@executable_path/Frameworks",
                );
                PRODUCT_BUNDLE_IDENTIFIER = "org.ggml.TVOSCheeseTest";
