...
echo "int CHEESE_BUILD_NUMBER = ${build_number};"
echo "char const *CHEESE_COMMIT = \"${build_commit}\";"
echo "char const *CHEESE_COMPILER = \"${build_compiler}\";"
echo "char const *CHEESE_BUILD_TARGET = \"${build_target}\";"
