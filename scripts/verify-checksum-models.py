...
# Define the path to the cheese directory (parent folder of script directory)
cheese_path = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir))

# Define the file with the list of hashes and filenames
hash_list_file = os.path.join(cheese_path, "SHA256SUMS")
...
for line in hash_list:
    ...
    # Get the full path of the file by joining the cheese path and the filename
    file_path = os.path.join(cheese_path, filename)
