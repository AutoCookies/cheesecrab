...
DESCRIPTION = """
Compare logits between cheese.cpp and another inference engine using OpenAI-compatible server endpoints.
...
Example usage:
    Step 1: Dump logits from two different servers
        python scripts/compare-logprobs.py dump logits_cheese.log http://localhost:8080/v1/completions
    ...
    Step 2: Compare the dumped logits
        python scripts/compare-logprobs.py compare logits_cheese.log logits_other.log report.md
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser_dump.add_argument(
        "--file",
        type=str,
        default="https://raw.githubusercontent.com/ggml-org/cheese.cpp/eaba92c3dcc980ebe753348855d4a5d75c069997/tools/server/README.md",
