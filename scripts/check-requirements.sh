...
cd "$(dirname "$this")/.." # PWD should stay in cheese.cpp project directory
...
check_convert_script examples/convert_legacy_cheese.py
for py in convert_*.py; do
    # skip convert_hf_to_gguf_update.py
    # TODO: the check is failing for some reason:
    #       https://github.com/ggml-org/cheese.cpp/actions/runs/8875330981/job/24364557177?pr=6920
