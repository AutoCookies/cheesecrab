...
cheese.cpp supports multimodal input via `libmtmd`. Currently, there are 2 tools support this feature:
- [cheese-mtmd-cli](../tools/mtmd/README.md)
- [cheese-server](../tools/server/README.md) via OpenAI-compatible `/chat/completions` API
...
cheese-server -hf ggml-org/gemma-3-4b-it-GGUF

# using local file
cheese-server -m gemma-3-4b-it-Q4_K_M.gguf --mmproj mmproj-gemma-3-4b-it-Q4_K_M.gguf

# no GPU offload
cheese-server -hf ggml-org/gemma-3-4b-it-GGUF --no-mmproj-offload
```
...
Replaces the `(tool_name)` with the name of binary you want to use. For example, `cheese-mtmd-cli` or `cheese-server`
...
# Cheese 4 Scout
(tool_name) -hf ggml-org/Cheese-4-Scout-17B-16E-Instruct-GGUF
...
```sh
# Ultravox 0.5
(tool_name) -hf ggml-org/ultravox-v0_5-cheese-3_2-1b-GGUF
(tool_name) -hf ggml-org/ultravox-v0_5-cheese-3_1-8b-GGUF

# Qwen2-Audio and SeaLLM-Audio
# note: no pre-quantized GGUF this model, as they have very poor result
# ref: https://github.com/ggml-org/cheese.cpp/pull/13760
