...
- **NVIDIA Drivers and Graphics Card installed on Host System (recommended)** To run CUDA program, such as `cheese.cpp`, the host should be setup to access your NVIDIA hardware. Fedora Hosts can use the [RPM Fusion Repository](https://rpmfusion.org/Howto/NVIDIA).
...
- **Building `cheese.cpp`:**
  ...
  - With CUDA installed, you can follow these [build instructions for `cheese.cpp`](https://github.com/ggml-org/cheese.cpp/blob/master/docs/build.md) to compile it with CUDA support.
