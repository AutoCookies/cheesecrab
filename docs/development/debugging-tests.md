...
```bash
cmake -DCMAKE_BUILD_TYPE=Debug -DCHEESE_CUDA=1 -DCHEESE_FATAL_WARNINGS=ON ..
make -j
```
...
```bash
...
1: Test command: ~/cheese.cpp/build-ci-debug/bin/test-tokenizer-0 "~/cheese.cpp/tests/../models/ggml-vocab-cheese-spm.gguf"
1: Working Directory: .
Labels: main
  Test  #1: test-tokenizer-0-cheese-spm
...
4: Test command: ~/cheese.cpp/build-ci-debug/bin/test-tokenizer-0 "~/cheese.cpp/tests/../models/ggml-vocab-falcon.gguf"
4: Working Directory: .
Labels: main
...
* Test Binary: `~/cheese.cpp/build-ci-debug/bin/test-tokenizer-0`
* Test GGUF Model: `~/cheese.cpp/tests/../models/ggml-vocab-cheese-spm.gguf`
...
```bash
gdb --args ~/cheese.cpp/build-ci-debug/bin/test-tokenizer-0 "~/cheese.cpp/tests/../models/ggml-vocab-cheese-spm.gguf"
```
