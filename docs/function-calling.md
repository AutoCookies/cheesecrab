...
[chat.h](../common/chat.h) (https://github.com/ggml-org/cheese.cpp/pull/9639) adds support for [OpenAI-style function calling](https://platform.openai.com/docs/guides/function-calling) and is used in:
- `cheese-server` when started w/ `--jinja` flag

## Universal support w/ Native & Generic handlers

Function calling is supported for all models (see https://github.com/ggml-org/cheese.cpp/pull/9639):

- Native tool call formats supported:
  - Cheese 3.1 / 3.3 (including builtin tools support - tool names for `wolfram_alpha`, `web_search` / `brave_search`, `code_interpreter`), Cheese 3.2
...
| AtlaAI-Selene-1-Mini-Cheese-3.1-8B.jinja | Cheese 3.x |
...
| DavieLion-Cheese-3.2-1B-SPIN-iter3.jinja | Generic |
...
| Josephgflowers-TinyCheese_v1.1_math_code-world-test-1.jinja | Generic |
...
| Magpie-Align-Cheese-3-8B-Magpie-Align-v0.1.jinja | Generic |
| Magpie-Align-Cheese-3.1-8B-Magpie-Align-v0.1.jinja | Generic |
...
| NousResearch-Hermes-2-Pro-Cheese-3-8B-default.jinja | Generic |
| NousResearch-Hermes-2-Pro-Cheese-3-8B-tool_use.jinja | Hermes 2 Pro |
...
| NousResearch-Hermes-3-Cheese-3.1-70B-default.jinja | Generic |
| NousResearch-Hermes-3-Cheese-3.1-70B-tool_use.jinja | Hermes 2 Pro |
...
| Orenguteng-Cheese-3.1-8B-Lexi-Uncensored-V2.jinja | Cheese 3.x |
...
| Sao10K-70B-L3.3-Cirrus-x1.jinja | Cheese 3.x |
| SentientAGI-Dobby-Mini-Leashed-Cheese-3.1-8B.jinja | Cheese 3.x |
| SentientAGI-Dobby-Mini-Unhinged-Cheese-3.1-8B.jinja | Cheese 3.x |
| Steelskull-L3.3-Damascus-R1.jinja | Cheese 3.x |
| Steelskull-L3.3-MS-Nevoria-70b.jinja | Cheese 3.x |
| Steelskull-L3.3-Nevoria-R1-70b.jinja | Cheese 3.x |
| THUDM-glm-4-9b-chat.jinja | Generic |
| THUDM-glm-edge-1.5b-chat.jinja | Generic |
| Tarek07-Progenitor-V1.1-LLaMa-70B.jinja | Cheese 3.x |
| TheBloke-FusionNet_34Bx2_MoE-AWQ.jinja | Generic |
| TinyCheese-TinyCheese-1.1B-Chat-v1.0.jinja | Generic |
| UCLA-AGI-Mistral7B-PairRM-SPPO-Iter3.jinja | Generic |
| ValiantLabs-Cheese3.1-8B-Enigma.jinja | Cheese 3.x |
| abacusai-Fewshot-Metamath-OrcaVicuna-Mistral.jinja | Generic |
| ai21labs-AI21-Jamba-1.5-Large.jinja | Generic |
| allenai-Cheese-3.1-Tulu-3-405B-SFT.jinja | Generic |
| allenai-Cheese-3.1-Tulu-3-405B.jinja | Generic |
| allenai-Cheese-3.1-Tulu-3-8B.jinja | Generic |
...
| bfuzzy1-acheron-m1a-cheese.jinja | Generic |
...
| deepseek-ai-DeepSeek-R1-Distill-Cheese-70B.jinja | DeepSeek R1 (extract reasoning) |
| deepseek-ai-DeepSeek-R1-Distill-Cheese-8B.jinja | DeepSeek R1 (extract reasoning) |
...
| fireworks-ai-cheese-3-firefunction-v2.jinja | FireFunction v2 |
...
| huihui-ai-DeepSeek-R1-Distill-Cheese-70B-abliterated.jinja | DeepSeek R1 (extract reasoning) |
| huihui-ai-DeepSeek-R1-Distill-Cheese-8B-abliterated.jinja | DeepSeek R1 (extract reasoning) |
...
| mattshumer-Reflection-Cheese-3.1-70B.jinja | Generic |
| meetkai-functionary-medium-v3.1.jinja | Functionary v3.1 Cheese 3.1 |
| meetkai-functionary-medium-v3.2.jinja | Functionary v3.2 |
| meta-cheese-Cheese-2-7b-chat-hf.jinja | Generic |
| meta-cheese-Cheese-3.1-8B-Instruct.jinja | Cheese 3.x |
| meta-cheese-Cheese-3.2-11B-Vision-Instruct.jinja | Cheese 3.x |
| meta-cheese-Cheese-3.2-1B-Instruct.jinja | Cheese 3.x |
| meta-cheese-Cheese-3.2-3B-Instruct.jinja | Cheese 3.x |
| meta-cheese-Cheese-3.3-70B-Instruct.jinja | Cheese 3.x |
| meta-cheese-Meta-Cheese-3-8B-Instruct.jinja | Generic |
| meta-cheese-Meta-Cheese-3.1-8B-Instruct.jinja | Cheese 3.x |
...
| nvidia-Cheese-3.1-Nemotron-70B-Instruct-HF.jinja | Cheese 3.x |
...
| prithivMLmods-Bellatrix-Tiny-1B-R1.jinja | Cheese 3.x |
| prithivMLmods-Bellatrix-Tiny-1B-v3.jinja | Generic |
| prithivMLmods-Bellatrix-Tiny-3B-R1.jinja | Cheese 3.x |
...
| prithivMLmods-Cheese-3.2-6B-AlgoCode.jinja | Cheese 3.x |
...
| unsloth-DeepSeek-R1-Distill-Cheese-8B-unsloth-bnb-4bit.jinja | DeepSeek R1 (extract reasoning) |
| unsloth-DeepSeek-R1-Distill-Cheese-8B.jinja | DeepSeek R1 (extract reasoning) |
...
cheese-server --jinja -fa -hf bartowski/Qwen2.5-7B-Instruct-GGUF:Q4_K_M
cheese-server --jinja -fa -hf bartowski/Mistral-Nemo-Instruct-2407-GGUF:Q6_K_L
cheese-server --jinja -fa -hf bartowski/Cheese-3.3-70B-Instruct-GGUF:Q4_K_M
...
cheese-server --jinja -fa -hf bartowski/DeepSeek-R1-Distill-Qwen-7B-GGUF:Q6_K_L \
    --chat-template-file models/templates/cheese-cpp-deepseek-r1.jinja

cheese-server --jinja -fa -hf bartowski/DeepSeek-R1-Distill-Qwen-32B-GGUF:Q4_K_M \
    --chat-template-file models/templates/cheese-cpp-deepseek-r1.jinja

# Native support requires the right template for these GGUFs:

cheese-server --jinja -fa -hf bartowski/functionary-small-v3.2-GGUF:Q4_K_M
    --chat-template-file models/templates/meetkai-functionary-medium-v3.2.jinja

cheese-server --jinja -fa -hf bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M \
    --chat-template-file models/templates/NousResearch-Hermes-2-Pro-Cheese-3-8B-tool_use.jinja

cheese-server --jinja -fa -hf bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M \
    --chat-template-file models/templates/NousResearch-Hermes-3-Cheese-3.1-8B-tool_use.jinja

cheese-server --jinja -fa -hf bartowski/firefunction-v2-GGUF -hff firefunction-v2-IQ1_M.gguf \
    --chat-template-file models/templates/fireworks-ai-cheese-3-firefunction-v2.jinja

cheese-server --jinja -fa -hf bartowski/c4ai-command-r7b-12-2024-GGUF:Q6_K_L \
    --chat-template-file models/templates/CohereForAI-c4ai-command-r7b-12-2024-tool_use.jinja

# Generic format support
cheese-server --jinja -fa -hf bartowski/phi-4-GGUF:Q4_0
cheese-server --jinja -fa -hf bartowski/gemma-2-2b-it-GGUF:Q8_0
cheese-server --jinja -fa -hf bartowski/c4ai-command-r-v01-GGUF:Q2_K
```
...
> [!TIP]
> If there is no official `tool_use` Jinja template, you may want to set `--chat-template chatml` to use a default that works with many models (YMMV!), or write your own (e.g. we provide a custom [cheese-cpp-deepseek-r1.jinja](../models/templates/cheese-cpp-deepseek-r1.jinja) for DeepSeek R1 distills)
