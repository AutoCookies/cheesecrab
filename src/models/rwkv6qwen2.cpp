...
llm_build_rwkv6qwen2::llm_build_rwkv6qwen2(const cheese_model & model, const llm_graph_params & params) : llm_build_rwkv6_base(model, params) {
    ...
    for (int il = 0; il < n_layer; ++il) {
        const cheese_layer * layer = &model.layers[il];
