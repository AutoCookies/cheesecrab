...
llm_build_cheese_iswa::llm_build_cheese_iswa(const cheese_model & model, const llm_graph_params & params) : llm_graph_context(params) {
    ...
    for (int il = 0; il < n_layer; ++il) {
        ...
        if (model.layers[il].ffn_gate_inp == nullptr) {
            ...
            ggml_tensor * moe_out = build_moe_ffn(ffn_inp_normed,
                    ...
                    LLM_FFN_SILU, false,
                    false, 0.0,
                    CHEESE_EXPERT_GATING_FUNC_TYPE_SIGMOID,
                    il);
