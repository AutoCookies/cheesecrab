...
template <bool iswa>
llm_build_lfm2<iswa>::llm_build_lfm2(const cheese_model & model, const llm_graph_params & params) :
    ...
    using mem_hybrid_ctx  = std::conditional_t<iswa, cheese_memory_hybrid_iswa_context, cheese_memory_hybrid_context>;
    ...
    auto build_moe_feed_forward = [&model, this](ggml_tensor * cur, int il) -> ggml_tensor * {
        return build_moe_ffn(cur,
                            ...
                            static_cast<cheese_expert_gating_func_type>(hparams.expert_gating_func), il);
    };
