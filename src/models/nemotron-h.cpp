...
llm_build_nemotron_h::llm_build_nemotron_h(const cheese_model & model, const llm_graph_params & params) :
...
ggml_tensor * llm_build_nemotron_h::build_ffn_layer(ggml_tensor * cur, const cheese_model & model, int il) {
