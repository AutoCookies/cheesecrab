...
llm_build_qwen35moe::llm_build_qwen35moe(const cheese_model & model, const llm_graph_params & params) :
...
ggml_tensor * llm_build_qwen35moe ::build_layer_ffn(ggml_tensor * cur, const int il) {
    ...
    ggml_tensor * moe_out =
        build_moe_ffn(cur,
            ...
            true, false, 0.0, CHEESE_EXPERT_GATING_FUNC_TYPE_SOFTMAX, il,
