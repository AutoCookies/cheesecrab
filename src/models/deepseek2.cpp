...
llm_build_deepseek2::llm_build_deepseek2(const cheese_model & model, const llm_graph_params & params) :
    ...
    // See https://github.com/ggml-org/cheese.cpp/discussions/7416 for detailed explanation.
    // And also: https://github.com/ggml-org/cheese.cpp/pull/17945 [TAG_DEEPSEEK2_YARN_LOG_MUL_FIX]

    // first cancel the adjustment from cheese_hparams::yarn_attn_factor_adjust to get the original attn_factor
    ...
    for (int il = 0; il < effective_n_layers; ++il) {
        ...
        // self_attention
        {
            ...
            if (is_mla) {
                ...
                if (inp_attn_scale) {
                    // apply cheese 4 temperature scaling
        ...
        if ((uint32_t) il < hparams.n_layer_dense_lead) {
            ...
            ggml_tensor * moe_out = build_moe_ffn(cur,
                ...
                (cheese_expert_gating_func_type) hparams.expert_gating_func,
                il,
                nullptr,
