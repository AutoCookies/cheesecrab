...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.CHEESE:            "cheese",
    MODEL_ARCH.CHEESE4:           "cheese4",
    ...
    MODEL_ARCH.CHEESE_EMBED:      "cheese-embed",
...
# from cheese_ftype in cheese.h
# ALL VALUES SHOULD BE THE SAME HERE AS THEY ARE OVER THERE.
class CheeseFileType(IntEnum):
    ALL_F32              = 0
