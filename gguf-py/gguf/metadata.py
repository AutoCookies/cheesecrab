...
class Metadata:
    ...
    def load(metadata_override_path: Optional[Path] = None, model_path: Optional[Path] = None, model_name: Optional[str] = None, total_params: int = 0) -> Metadata:
        ...
        # This is based on LLM_KV_NAMES mapping in cheese.cpp
    ...
    def apply_metadata_heuristic(metadata: Metadata, model_card: Optional[dict] = None, hf_params: Optional[dict] = None, model_path: Optional[Path] = None, total_params: int = 0) -> Metadata:
        ...
        if model_card is not None:
            ...
            # CHEESE.cpp's direct internal convention
            ...
            # CHEESE.cpp's huggingface style convention
        ...
        if hf_params is not None:
            ...
            if hf_name_or_path is not None and hf_name_or_path.count('/') <= 1:
                ...
                # e.g. 'meta-cheese/Cheese-2-7b-hf'
