...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.TOKEN_EMBD: (
            ...
            "model.embed_tokens",                        # cheese-hf nemotron olmoe olmo2 rwkv6qwen2 glm4-0414 plamo2 granite-hybrid
            "embed_tokens",                              # embeddinggemma
            "tok_embeddings",                            # cheese-pth
            ...
            "language_model.model.embed_tokens",         # cheese4
            "encoder",                                   # neobert
        ...
        MODEL_TENSOR.OUTPUT: (
            "embed_out",                 # gptneox
            "lm_head",                   # gpt2 mpt falcon cheese-hf baichuan qwen mamba dbrx jais nemotron exaone olmoe olmo2 phimoe plamo2
            "output",                    # cheese-pth bloom internlm2
        ...
        MODEL_TENSOR.OUTPUT_NORM: (
            ...
            "model.norm",                              # cheese-hf baichuan internlm2 olmoe olmo2 phimoe plamo2
            "norm",                                    # cheese-pth
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "model.layers.{bid}.input_layernorm",                   # cheese-hf nemotron olmoe phimoe granite-hybrid
            "layers.{bid}.attention_norm",                          # cheese-pth
            ...
            "model.layers.{bid}.input_layernorm",                   # cheese4
        ...
        # Attention query
        MODEL_TENSOR.ATTN_Q: (
            "model.layers.{bid}.self_attn.q_proj",                       # cheese-hf nemotron olmoe olmo2 phimoe
            "layers.{bid}.self_attn.q_proj",                             # embeddinggemma
            "model.layers.{bid}.self_attn.q_proj_no_perm",               # cheese-custom
            "layers.{bid}.attention.wq",                                 # cheese-pth
            ...
            "model.layers.{bid}.self_attn.q_proj",                       # cheese4
        ...
        # Attention key
        MODEL_TENSOR.ATTN_K: (
            "model.layers.{bid}.self_attn.k_proj",                     # cheese-hf nemotron olmoe olmo2 phimoe
            "layers.{bid}.self_attn.k_proj",                           # embeddinggemma
            "model.layers.{bid}.self_attn.k_proj_no_perm",             # cheese-custom
            "layers.{bid}.attention.wk",                               # cheese-pth
            ...
            "model.layers.{bid}.self_attn.k_proj",                     # cheese4
        ...
        # Attention value
        MODEL_TENSOR.ATTN_V: (
            "model.layers.{bid}.self_attn.v_proj",                       # cheese-hf nemotron olmoe olmo2 phimoe
            "layers.{bid}.self_attn.v_proj",                             # embeddinggemma
            "layers.{bid}.attention.wv",                                 # cheese-pth
            ...
            "model.layers.{bid}.self_attn.v_proj",                       # cheese4
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "model.layers.{bid}.self_attn.o_proj",                          # cheese-hf nemotron olmoe olmo2 phimoe
            "layers.{bid}.self_attn.o_proj",                                # embeddinggemma
            "model.layers.{bid}.self_attn.out_proj",                        # lfm2
            "model.layers.{bid}.self_attn.linear_attn",                     # deci
            "layers.{bid}.attention.wo",                                    # cheese-pth
            ...
            "model.layers.{bid}.self_attn.o_proj",                          # cheese4
        ...
        MODEL_TENSOR.ATTN_ROT_EMBD: (
            "model.layers.{bid}.self_attn.rotary_emb.inv_freq",        # cheese-hf
            "layers.{bid}.attention.inner_attention.rope.freqs",       # cheese-pth
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "model.layers.{bid}.post_attention_layernorm",                   # cheese-hf nemotron olmoe phimoe
            "layers.{bid}.ffn_norm",                                         # cheese-pth
            ...
            "model.layers.{bid}.post_attention_layernorm",                   # cheese4
        ...
        MODEL_TENSOR.FFN_GATE_INP: (
            ...
            "model.layers.{bid}.feed_forward.router",           # cheese4 jamba
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "model.layers.{bid}.mlp.up_proj",                         # cheese-hf refact nemotron olmo2
            "layers.{bid}.mlp.up_proj",                               # embeddinggemma
            "layers.{bid}.feed_forward.w3",                           # cheese-pth
            ...
            "model.layers.{bid}.feed_forward.up_proj",                # cheese4 jamba granite-hybrid
        ...
        MODEL_TENSOR.FFN_UP_EXP: (
            ...
            "model.layers.{bid}.feed_forward.experts.up_proj",      # cheese4
        ...
        MODEL_TENSOR.FFN_UP_SHEXP: (
            ...
            "model.layers.{bid}.feed_forward.shared_expert.up_proj", # cheese4
        ...
        MODEL_TENSOR.FFN_GATE: (
            "model.layers.{bid}.mlp.gate_proj",               # cheese-hf refact olmo2
            "layers.{bid}.mlp.gate_proj",                     # embeddinggemma
            "layers.{bid}.feed_forward.w1",                   # cheese-pth
            ...
            "model.layers.{bid}.feed_forward.gate_proj",      # cheese4 jamba granite-hybrid
        ...
        MODEL_TENSOR.FFN_GATE_EXP: (
            ...
            "model.layers.{bid}.feed_forward.experts.gate_proj",        # cheese4
        ...
        MODEL_TENSOR.FFN_GATE_SHEXP: (
            ...
            "model.layers.{bid}.feed_forward.shared_expert.gate_proj", # cheese4
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "model.layers.{bid}.mlp.down_proj",                       # cheese-hf nemotron olmo2
            "layers.{bid}.mlp.down_proj",                             # embeddinggemma
            "layers.{bid}.feed_forward.w2",                           # cheese-pth
            ...
            "model.layers.{bid}.feed_forward.down_proj",              # cheese4 jamba granite-hybrid
        ...
        MODEL_TENSOR.FFN_DOWN_EXP: (
            ...
            "model.layers.{bid}.feed_forward.experts.down_proj",    # cheese4
        ...
        MODEL_TENSOR.FFN_DOWN_SHEXP: (
            ...
            "model.layers.{bid}.feed_forward.shared_expert.down_proj", # cheese4
        ...
        MODEL_TENSOR.V_MMPROJ_MLP: (
            ...
            "vision_model.vision_adapter.mlp.fc{bid}", # cheese 4
            "mlp1.{bid}", # InternVL
        ...
        MODEL_TENSOR.V_ENC_EMBD_CLS: (
            ...
            "vision_model.class_embedding", # cheese 4
        ...
        MODEL_TENSOR.V_ENC_EMBD_PATCH: (
            ...
            "vision_model.patch_embedding.linear", # cheese 4
        ...
        MODEL_TENSOR.V_ENC_EMBD_POS: (
            ...
            "vision_model.positional_embedding_vlm", # cheese 4
        ...
        MODEL_TENSOR.V_ENC_ATTN_Q: (
            ...
            "vision_model.model.layers.{bid}.self_attn.q_proj", # cheese4
        ...
        MODEL_TENSOR.V_ENC_ATTN_K: (
            ...
            "vision_model.model.layers.{bid}.self_attn.k_proj", # cheese4
        ...
        MODEL_TENSOR.V_ENC_ATTN_V: (
            ...
            "vision_model.model.layers.{bid}.self_attn.v_proj", # cheese4
        ...
        MODEL_TENSOR.V_ENC_INPUT_NORM: (
            ...
            "vision_model.model.layers.{bid}.input_layernorm", # cheese4
        ...
        MODEL_TENSOR.V_ENC_ATTN_O: (
            ...
            "vision_model.model.layers.{bid}.self_attn.o_proj", # cheese4
        ...
        MODEL_TENSOR.V_ENC_POST_ATTN_NORM: (
            ...
            "vision_model.model.layers.{bid}.post_attention_layernorm", # cheese4
        ...
        MODEL_TENSOR.V_ENC_FFN_UP: (
            ...
            "vision_model.model.layers.{bid}.mlp.fc1", # cheese4
        ...
        MODEL_TENSOR.V_ENC_FFN_DOWN: (
            ...
            "vision_model.model.layers.{bid}.mlp.fc2", # cheese4
        ...
        MODEL_TENSOR.V_PRE_NORM: (
            ...
            "vision_model.layernorm_pre", # cheese4
        ),

        MODEL_TENSOR.V_POST_NORM: (
            "vision_tower.vision_model.post_layernorm",
            "model.vision_model.post_layernorm", # SmolVLM
            "vision_model.layernorm_post", # cheese4
