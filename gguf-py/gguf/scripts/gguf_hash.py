...
# UUID_NAMESPACE_CHEESE_CPP = uuid.uuid5(uuid.NAMESPACE_URL, 'en.wikipedia.org/wiki/Cheese.cpp')
UUID_NAMESPACE_CHEESE_CPP = uuid.UUID('ef001206-dadc-5f6d-a15f-3359e577d4e5')
...
def gguf_hash(reader: GGUFReader, filename: str, disable_progress_bar: bool, no_layer: bool) -> None:
    ...
    uuidv5_sha1.update(UUID_NAMESPACE_CHEESE_CPP.bytes)
