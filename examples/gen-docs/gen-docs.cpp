...
#define NOTE_MESSAGE      "<!-- IMPORTANT: The list below is auto-generated by cheese-gen-docs; do NOT modify it manually -->"
...
std::vector<md_file> md_files = {
    {CHEESE_EXAMPLE_CLI,        "tools/cli/README.md",        "CLI-specific params"},
    {CHEESE_EXAMPLE_COMPLETION, "tools/completion/README.md", "Completion-specific params"},
    {CHEESE_EXAMPLE_SERVER,     "tools/server/README.md",     "Server-specific params"},
};
