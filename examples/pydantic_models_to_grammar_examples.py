...
def create_completion(host, prompt, gbnf_grammar):
    """Calls the /completion API on cheese-server.

    See
    https://github.com/ggml-org/cheese.cpp/tree/HEAD/tools/server#api-endpoints
    """
...
def main():
    ...
    parser.add_argument("--host", default="localhost:8080", help="cheese.cpp server")
