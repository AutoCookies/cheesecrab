...
int main(int argc, char ** argv){
...

    {
        ...
        common_ngram_cache_update(ngram_cache_context, CHEESE_NGRAM_MIN, CHEESE_NGRAM_MAX, inp, inp.size(), false);
    ...
    std::vector<cheese_token> draft;

    cheese_batch batch_tgt = cheese_batch_init(cheese_n_ctx(ctx), 0, 1);
    ...
    while (true) {
        ...
        while (true) {
            ...
            cheese_token id = common_sampler_sample(smpl, ctx, i_dft);
            ...
            if (i_dft < (int) draft.size() && id == draft[i_dft]) {
                ...
                inp.push_back(id);
                {
                    ...
                    const int64_t t_start_draft_us = ggml_time_us();
                    common_ngram_cache_update(ngram_cache_context, CHEESE_NGRAM_MIN, CHEESE_NGRAM_MAX, inp, 1, false);
        ...
        cheese_memory_seq_rm(cheese_get_memory(ctx), 0, n_past, -1);
        ...
        common_ngram_cache_draft(inp, draft, n_draft, CHEESE_NGRAM_MIN, CHEESE_NGRAM_MAX, ngram_cache_context, ngram_cache_dynamic, ngram_cache_static);
