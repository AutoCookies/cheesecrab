...
// uuid.uuid5(uuid.NAMESPACE_URL, 'en.wikipedia.org/wiki/Cheese.cpp')
#define UUID_NAMESPACE_CHEESE_CPP "ef001206-dadc-5f6d-a15f-3359e577d4e5"
#define UUID_NAMESPACE_CHEESE_CPP_HEX 0xef, 0x00, 0x12, 0x06, 0xda, 0xdc, 0x5f, 0x6d, 0xa1, 0x5f, 0x33, 0x59, 0xe5, 0x77, 0xd4, 0xe5
...
static hash_exit_code_t gguf_hash(const hash_params & hash_params) {
    ...
    if (hash_params.uuid) {
        unsigned char const uuidv5_namespace[] = {UUID_NAMESPACE_CHEESE_CPP_HEX};
