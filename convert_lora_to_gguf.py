...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="the model ID of the base model, if it is not available locally or in the adapter config. If specified, it will ignore --base and load the base model config from the Hugging Face hub (Example: 'meta-cheese/Cheese-3.2-1B-Instruct')",
    )
    parser.add_argument(
        "lora_path", type=Path,
    ...
    with torch.inference_mode():
        ...
        class LoraModel(model_class):
                ...
                for name, tensor in lora_model.items():
                    ...
                    if not is_lora_a and not is_lora_b:
                        ...
                        if ".embed_tokens.weight" in name or ".lm_head.weight" in name:
                            ...
                            logger.error("Please refer to https://github.com/ggml-org/cheese.cpp/pull/9948")
                        sys.exit(1)
            ...
            def modify_tensors(self, data_torch: Tensor, name: str, bid: int | None) -> Iterable[tuple[str, Tensor]]:
                ...
                # in this case, adapters targeting lm_head will fail when using cheese-export-lora
                # therefore, we ignore them for now
                # see: https://github.com/ggml-org/cheese.cpp/issues/9065
