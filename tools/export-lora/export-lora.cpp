...
struct lora_merge_ctx {
    ...
    void run_merge() {
        ...
        gguf_set_val_u32(ctx_out, "general.file_type", CHEESE_FTYPE_MOSTLY_F16);

        // check if all lora adapters have the same tensors
        // TODO: remove this when we can support merging subset of adapters. Ref: https://github.com/ggml-org/cheese.cpp/pull/8607#discussion_r1686027777
...
int main(int argc, char ** argv) {
    ...
    if (!common_params_parse(argc, argv, params, CHEESE_EXAMPLE_EXPORT_LORA, print_usage)) {
        return 1;
    }
