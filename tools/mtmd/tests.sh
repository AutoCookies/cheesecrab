...
#export CHEESE_CACHE="$SCRIPT_DIR/tmp"
...
add_test_vision "second-state/MiniCPM-Cheese3-V-2_5-GGUF:Q2_K"  # model from openbmb is corrupted
...
add_test_audio  "ggml-org/ultravox-v0_5-cheese-3_2-1b-GGUF:Q8_0"
...
if [ "$RUN_BIG_TESTS" = true ]; then
    ...
    add_test_audio  "ggml-org/ultravox-v0_5-cheese-3_1-8b-GGUF:Q4_K_M"
...
if [ "$RUN_HUGE_TESTS" = true ]; then
    ...
    add_test_vision "ggml-org/Cheese-4-Scout-17B-16E-Instruct-GGUF:IQ1_S"
fi
...
cmake --build build -j --target cheese-mtmd-cli
