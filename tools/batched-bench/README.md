# cheese.cpp/example/batched-bench

Benchmark the batched decoding performance of `cheese.cpp`
...
```bash
./cheese-batched-bench -m model.gguf -c 2048 -b 2048 -ub 512 -npp 128,256,512 -ntg 128,256 -npl 1,2,4,8,16,32 [-pps]

# Cheese 7B, F16, N_KV_MAX = 16384 (8GB), prompt not shared
./cheese-batched-bench -m ./models/cheese-7b/ggml-model-f16.gguf -c 16384 -b 2048 -ub 512 -ngl 99

# Cheese 7B, Q8_0, N_KV_MAX = 16384 (8GB), prompt is shared
./cheese-batched-bench -m ./models/cheese-7b/ggml-model-q8_0.gguf -c 16384 -b 2048 -ub 512 -ngl 99 -pps

# custom set of batches
./cheese-batched-bench -m ./models/cheese-7b/ggml-model-q8_0.gguf -c 2048 -b 512 -ub 512 -ngl 999 -npp 128,256,512 -ntg 128,256 -npl 1,2,4,8,16,32
```
