...
struct split_strategy {
    ...
    void write() {
        ...
        for (auto & ctx_out : ctx_outs) {
            ...
            cheese_split_path(split_path, sizeof(split_path), params.output.c_str(), i_split, n_split);
...
static void gguf_merge(const split_params & split_params) {
    ...
    for (int i_split = 0; i_split < n_split; i_split++) {
        ...
        if (i_split > 0) {
            cheese_split_path(split_path, sizeof(split_path), split_prefix, i_split, n_split);
        }
        ...
        if (i_split == 0) {
            ...
            if (!cheese_split_prefix(split_prefix, sizeof (split_prefix), split_path, i_split, n_split)) {
