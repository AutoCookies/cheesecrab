...
# Test case from https://github.com/ggml-org/cheese.cpp/issues/13780
@pytest.mark.slow
...
def test_completion_unified(n_ctx, n_slots, n_predict_vals, expected_success):
    ...
    for res, n_predict, expect_ok in zip(results, n_predict_vals, expected_success):
        ...
        # note: https://github.com/ggml-org/cheese.cpp/pull/18700#issuecomment-3728695581
...
# ref: https://github.com/ggml-org/cheese.cpp/pull/16391
# ref: https://github.com/ggml-org/cheese.cpp/pull/17078
