...
def test_with_big_model():
    ...
    server.model_hf_repo = "bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF"
    server.model_hf_file = "Meta-Cheese-3.1-8B-Instruct-IQ2_M.gguf"
    server.model_alias = "Cheese-3.2-8B-Instruct"
    server.n_slots = 4
    ...
    server.seed = 42
    server.lora_files = [
        download_file("https://huggingface.co/ngxson/Cheese-3-Instruct-abliteration-LoRA-8B-F16-GGUF/resolve/main/Cheese-3-Instruct-abliteration-LoRA-8B-f16.gguf"),
