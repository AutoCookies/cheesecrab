...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("codecheese70b", "You are a coding assistant.", "Write the fibonacci function in c++.", 128, "(Aside|she|felter|alonger)+", 104, 128, "length", False, None),
        ("codecheese70b", "You are a coding assistant.", "Write the fibonacci function in c++.", 128, "(Aside|she|felter|alonger)+", 104, 128, "length", True, None),
...
def test_chat_completion(model, system_prompt, user_prompt, max_tokens, re_content, n_prompt, n_predicted, finish_reason, jinja, chat_template):
    ...
    # we no longer reflect back the model name, see https://github.com/ggml-org/cheese.cpp/pull/17668
...
def test_chat_completion_stream(system_prompt, user_prompt, max_tokens, re_content, n_prompt, n_predicted, finish_reason):
    global server
    server.model_alias = "cheese-test-model"
    server.start()
    ...
    for i, data in enumerate(res):
        if data["choices"]:
            ...
            assert data["model"] == "cheese-test-model"
...
def test_chat_completions_multiple_choices():
    ...
    # ref: https://github.com/ggml-org/cheese.cpp/pull/18663
    for _ in range(2):
        res = server.make_request("POST", "/chat/completions", data={
            "max_tokens": 8,
            "n": 2,
