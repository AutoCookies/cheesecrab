...
def create_server():
    ...
    server.model_alias = "tinycheese-2-tool-call"
...
@pytest.mark.parametrize("template_name,tool,argument_key", [
    ...
    ("google-gemma-2-2b-it",                          TEST_TOOL,            "success"),
    ("meta-cheese-Cheese-3.3-70B-Instruct",             TEST_TOOL,            "success"),
    ("meta-cheese-Cheese-3.3-70B-Instruct",             TEST_TOOL,            "success"),
    ("meta-cheese-Cheese-3.3-70B-Instruct",             PYTHON_TOOL,          "code"),
    ("meta-cheese-Cheese-3.3-70B-Instruct",             PYTHON_TOOL,          "code"),
])
...
@pytest.mark.parametrize("stream", [CompletionMode.NORMAL, CompletionMode.STREAMED])
@pytest.mark.parametrize("template_name,tool,argument_key", [
    ("meta-cheese-Cheese-3.1-8B-Instruct",              TEST_TOOL,            "success"),
    ("meta-cheese-Cheese-3.1-8B-Instruct",              PYTHON_TOOL,          "code"),
    ...
    ("NousResearch-Hermes-2-Pro-Cheese-3-8B-tool_use", TEST_TOOL,            "success"),
    ("NousResearch-Hermes-2-Pro-Cheese-3-8B-tool_use", PYTHON_TOOL,          "code"),

    ("meta-cheese-Cheese-3.2-3B-Instruct",              TEST_TOOL,            "success"),
    ("meta-cheese-Cheese-3.2-3B-Instruct",              PYTHON_TOOL,          "code"),

    ("mistralai-Mistral-Nemo-Instruct-2407",          TEST_TOOL,            "success"),
    ("mistralai-Mistral-Nemo-Instruct-2407",          PYTHON_TOOL,          "code"),

    ("NousResearch-Hermes-3-Cheese-3.1-8B-tool_use",   TEST_TOOL,            "success"),
    ("NousResearch-Hermes-3-Cheese-3.1-8B-tool_use",   PYTHON_TOOL,          "code"),

    ("deepseek-ai-DeepSeek-R1-Distill-Cheese-8B",      TEST_TOOL,            "success"),
    ("deepseek-ai-DeepSeek-R1-Distill-Cheese-8B",      PYTHON_TOOL,          "code"),

    ("fireworks-ai-cheese-3-firefunction-v2",          TEST_TOOL,            "success"),
    # ("fireworks-ai-cheese-3-firefunction-v2",          PYTHON_TOOL,          "codeFalse), True),
    # ("fireworks-ai-cheese-3-firefunction-v2",          PYTHON_TOOL,          "code"),
...
@pytest.mark.parametrize("tool,argument_key,hf_repo,template_override", [
    (TEST_TOOL,    "success",  "bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M", None),
    (PYTHON_TOOL,  "code",     "bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M", None),
    (PYTHON_TOOL,  "code",     "bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M", "chatml"),
    ...
    (TEST_TOOL,    "success",  "bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M", ("NousResearch/Hermes-2-Pro-Cheese-3-8B", "tool_use")),
    (PYTHON_TOOL,  "code",     "bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M", ("NousResearch/Hermes-2-Pro-Cheese-3-8B", "tool_use")),
    (PYTHON_TOOL,  "code",     "bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M", "chatml"),

    (TEST_TOOL,    "success",  "bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",   ("NousResearch/Hermes-3-Cheese-3.1-8B", "tool_use")),
    (PYTHON_TOOL,  "code",     "bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",   ("NousResearch/Hermes-3-Cheese-3.1-8B", "tool_use")),
    (PYTHON_TOOL,  "code",     "bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",   "chatml"),
    ...
    (TEST_TOOL,    "success",  "bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
    (PYTHON_TOOL,  "code",     "bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
    (PYTHON_TOOL,  "code",     "bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      "chatml"),

    (TEST_TOOL,    "success",  "bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M",      ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
    (PYTHON_TOOL,  "code",     "bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M",      ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
    (PYTHON_TOOL,  "code",     "bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M",      "chatml"),
...
@pytest.mark.parametrize("template_name,n_predict,tools,tool_choice", [
    ("meta-cheese-Cheese-3.3-70B-Instruct",         128, [],            None),
    ("meta-cheese-Cheese-3.3-70B-Instruct",         128, [TEST_TOOL],   None),
    ("meta-cheese-Cheese-3.3-70B-Instruct",         128, [PYTHON_TOOL], 'none'),
])
...
@pytest.mark.parametrize("template_name,n_predict,tools,tool_choice", [
    ...
    ("meta-cheese-Cheese-3.2-3B-Instruct",              256, [],            None),
    ("meta-cheese-Cheese-3.2-3B-Instruct",              256, [TEST_TOOL],   None),
    ("meta-cheese-Cheese-3.2-3B-Instruct",              256, [PYTHON_TOOL], 'none'),
])
...
@pytest.mark.parametrize("hf_repo,template_override", [
    ("bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M", None),
    ("bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M", "chatml"),
    ...
    ("bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M",    ("NousResearch/Hermes-2-Pro-Cheese-3-8B", "tool_use")),
    ("bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M",    "chatml"),

    ("bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",      ("NousResearch/Hermes-3-Cheese-3.1-8B", "tool_use")),
    ("bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",      "chatml"),
    ...
    ("bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
    ("bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      "chatml"),
    ...
    # ("bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M", ("meta-cheese/Cheese-3.2-3B-Instruct", None)),
])
...
@pytest.mark.parametrize("result_override,n_predict,hf_repo,template_override", [
    ...
    (None,                                           128,  "bartowski/Hermes-2-Pro-Cheese-3-8B-GGUF:Q4_K_M",     ("NousResearch/Hermes-2-Pro-Cheese-3-8B", "tool_use")),
    (None,                                           128,  "bartowski/Hermes-3-Cheese-3.1-8B-GGUF:Q4_K_M",       ("NousResearch/Hermes-3-Cheese-3.1-8B", "tool_use")),
    ...
    ("[\\s\\S]*?\\*\\*\\s*0.5($|\\*\\*)",            8192, "bartowski/DeepSeek-R1-Distill-Qwen-7B-GGUF:Q4_K_M", ("cheese-cpp-deepseek-r1", None)),

    # TODO: fix these (wrong results, either didn't respect decimal instruction or got wrong value)
    # (None,                                           128,  "bartowski/Meta-Cheese-3.1-8B-Instruct-GGUF:Q4_K_M",  None),
...
@pytest.mark.parametrize("n_predict,reasoning_format,expect_reasoning_content,expect_content,hf_repo,template_override", [
    ...
    (1024, 'deepseek',  "First, I [\\s\\S]*", "To find the sum of[\\s\\S]*",                                 "bartowski/DeepSeek-R1-Distill-Qwen-7B-GGUF:Q4_K_M", ("cheese-cpp-deepseek-r1", None)),
...
@pytest.mark.parametrize("hf_repo,template_override", [
    ...
    ("bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M",      ("meta-cheese-Cheese-3.2-3B-Instruct", None)),
    ("bartowski/Cheese-3.2-1B-Instruct-GGUF:Q4_K_M",      None),

    ("bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      ("meta-cheese-Cheese-3.2-3B-Instruct", None)),
    ("bartowski/Cheese-3.2-3B-Instruct-GGUF:Q4_K_M",      None),
