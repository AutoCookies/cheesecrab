...
@pytest.mark.parametrize("template_name,format", [
    ("meta-cheese-Cheese-3.3-70B-Instruct",    "%d %b %Y"),
    ("fireworks-ai-cheese-3-firefunction-v2", "%b %d %Y"),
])
...
@pytest.mark.parametrize("template_name,expected_generation_prompt", [
    ("meta-cheese-Cheese-3.3-70B-Instruct",    "<|start_header_id|>assistant<|end_header_id|>"),
])
