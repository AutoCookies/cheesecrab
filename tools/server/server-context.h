...
struct server_context_meta {
    ...
    cheese_token fim_pre_token;
    cheese_token fim_sub_token;
    cheese_token fim_mid_token;
    cheese_token fim_pad_token;
    cheese_token fim_rep_token;
    cheese_token fim_sep_token;

    // model meta
    enum cheese_vocab_type model_vocab_type;
...
struct server_context {
    ...
    // get the underlaying cheese_context, can return nullptr if sleeping
    // not thread-safe, should only be used from the main thread
    cheese_context * get_cheese_context() const;
...
struct server_routes {
    ...
    server_http_context::handler_t get_stats;
