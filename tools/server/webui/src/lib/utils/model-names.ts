 ...
 *
 * @example
 * normalizeModelName('models/cheese-3.1-8b') // Returns: 'cheese-3.1-8b' (multiple slashes -> filename)
 * normalizeModelName('C:\\Models\\gpt-4') // Returns: 'gpt-4' (multiple slashes -> filename)
 * normalizeModelName('meta-cheese/Cheese-3.1-8B') // Returns: 'meta-cheese/Cheese-3.1-8B' (Hugging Face format)
