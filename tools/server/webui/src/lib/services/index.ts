 ...
 *
 * Handles direct communication with the cheese-server's `/v1/chat/completions` endpoint.
 ...
 *   - Handles HTTP requests/responses with the cheese-server
 ...
 *   - Returns typed `ApiCheeseCppServerProps` responses
 *
