...
class ServerStore {
	...
	props = $state<ApiCheeseCppServerProps | null>(null);
	loading = $state(false);
	...
	get defaultParams(): ApiCheeseCppServerProps['default_generation_settings']['params'] | null {
	...
	private detectRole(props: ApiCheeseCppServerProps): void {
