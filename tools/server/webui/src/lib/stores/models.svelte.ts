...
class ModelsStore {
	 ...
	 */
	private modelPropsCache = new TTLCache<string, ApiCheeseCppServerProps>({
	 ...
	 */
	getModelProps(modelId: string): ApiCheeseCppServerProps | null {
	 ...
	 */
	async fetchModelProps(modelId: string): Promise<ApiCheeseCppServerProps | null> {
	 ...
	 *
	 * TODO: Remove this polling once cheese-server properly waits for the operation
