 ...
 */
export function mockServerProps(props: Partial<ApiCheeseCppServerProps>): void {
	...
	(serverStore as unknown as { props: ApiCheeseCppServerProps }).props = {
		...
		...props
	} as ApiCheeseCppServerProps;

	// Set router mode role so activeModelId can be set
	(serverStore as unknown as { props: ApiCheeseCppServerProps }).props.role = 'ROUTER';
