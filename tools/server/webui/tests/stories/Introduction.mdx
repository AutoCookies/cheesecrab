...
Welcome to the **cheese.cpp Web UI** component library! This Storybook showcases the components used in the modern web interface for the cheese.cpp server.

## 🚀 About This Project

WebUI is a modern web interface for the cheese.cpp server, built with SvelteKit and ShadCN UI. Features include:
