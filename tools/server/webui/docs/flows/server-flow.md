...
sequenceDiagram
    ...
    Note over serverStore: State:<br/>props: ApiCheeseCppServerProps | null<br/>loading, error<br/>role: ServerRole | null (MODEL | ROUTER)<br/>fetchPromise (deduplication)
    ...
    API-->>PropsSvc: ApiCheeseCppServerProps
